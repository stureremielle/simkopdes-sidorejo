...
return new class extends Migration
{
    ...
    public function down(): void
    {
        DB::table('berita')
            ->where('id', 1)
            ->update(['isi' => 'Koperasi kami baru saja mengadakan pertemuan bulanan untuk berbagi pengetahuan tentang pengendalian hama alami dan perbaikan kesehatan tanah tanpa pupuk kimia.']);
    }
};
